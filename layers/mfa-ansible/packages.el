...
(defconst mfa-ansible-packages '(ansible
                                 ansible-doc company
                                 company-ansible
                                 expand-region
                                 flycheck
...
(defun mfa-ansible//font-lock-extend-region ()
  (eval-when-compile
...
;; (defun mfa-ansible/test-font-lock-extend-region ()
;;   (interactive)
;;   (when (mfa-ansible//font-lock-extend-region)
...
(defun mfa-ansible//font-lock-setup ()
  ;; Preserve highlight of multiline Jinja2 blocks.
  (setq font-lock-multiline t)
  ;; (push #'mfa-ansible//font-lock-extend-region font-lock-extend-region-functions)
  )

(defun mfa-ansible/post-init-orglink ()
