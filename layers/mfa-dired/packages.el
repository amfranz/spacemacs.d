...
(defconst mfa-dired-packages '(all-the-icons
...
(defun mfa-dired/init-all-the-icons-dired ()
  (use-package all-the-icons-dired
    ...
    (advice-add 'all-the-icons-dired--display
                :override #'mfa-dired//all-the-icons-dired--display)))
...
;;
;; (defun mfa-dired/post-init-diff-hl ()
...
(defun mfa-dired/post-init-dired ()
  ...
  (with-eval-after-load 'dired
    (evilified-state-evilify-map dired-mode-map
      ...
      "oh" #'mfa-dired/find-file-horizontal-split
      "ov" #'mfa-dired/find-file-vertical-split
      "oaa" #'mfa-dired/find-file-ace
      "oah" #'mfa-dired/find-file-ace-horizontal-split
      "oav" #'mfa-dired/find-file-ace-vertical-split
...
(defun mfa-dired/init-dired+ ()
  (use-package dired+
    :hook (dired-mode . mfa-dired//require-dired+)
    :config
    (progn
...
(defun mfa-dired/init-dired-filter ()
...
(defun mfa-dired/init-dired-subtree ()
  (use-package dired-subtree
    :defer t
    :init
    (progn
      (add-hook 'all-the-icons-dired-mode-hook
                #'mfa-dired//dired-subtree--insert-all-the-icons)
      (with-eval-after-load 'dired
...
(defun mfa-dired/post-init-dired-x ()
...
(defun mfa-dired/init-image-dired ()
  (setq image-dired-dir (concat spacemacs-cache-directory "image-dired/")))

(defun mfa-dired/post-init-font-lock+ ()
