(defconst mfa-highlight-symbols-packages '(highlight-escape-sequences highlight-numbers))

(defun mfa-highlight-symbols/init-highlight-escape-sequences ()
...
(defun mfa-highlight-symbols/post-init-highlight-numbers ()
