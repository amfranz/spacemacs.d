...
(defun mfa-treemacs/init-treemacs-icons-dired ()
  (use-package treemacs-icons-dired
    :after dired
    :config (treemacs-icons-dired-mode)))

(defun mfa-treemacs/init-treemacs-magit ()
