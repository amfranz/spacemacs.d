...
(defconst my-shell-scripts-packages '(flycheck-bashate
                                      flycheck-checkbashisms
                                      (sh-script :location built-in)))

(defun my-shell-scripts/post-init-flycheck-bashate ()
...
(defun my-shell-scripts/init-flycheck-checkbashisms ()
  (use-package flycheck-checkbashisms
    :if (configuration-layer/package-usedp 'flycheck)
    :after (sh-script flycheck)
    :config (flycheck-checkbashisms-setup)))

(defun my-shell-scripts/post-init-sh-script ()
  ...
  (add-hook 'sh-mode-hook #'my-shell-scripts//adjust-indentation))
